...
export default function CarsSearchBar() {
  ...
  return (
    <div
      className="w-full flex flex-col xl:flex-row justify-center items-center gap-4 mt-4 xl:mt-0 mb-4 "
      dir="rtl"
    >
      <form onSubmit={handleSearch} className="w-full  flex flex-col xl:flex-row justify-center items-center gap-4 xl:gap-0">
        ...
        <div className="flex h-[3em] w-full">
          <div className="relative w-full focus-within:border-green-500 active min-h-[1.5em] border-none bg-gray-100 border-[#777] flex items-center gap-[.5em] p-[.5em] rounded-full rounded-e-none xl:rounded-s-none focus:border-green-500">
            <Image
          ...
          <Button type="submit" className=" h-full rounded-s-none">
            <Search size={20} />
          </Button>
        </div>
      </form>
      <div className="w-full grid grid-cols-2 gap-4 xl:w-2/3">
