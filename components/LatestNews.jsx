    ...
    <section className="Latest-section relative grid grid-cols-1 lg:grid-cols-3 mx-auto sm:px-16 px-6 mt-2 w-full mb-4">
      <div className="col-span-2 flex flex-col items-start justify-center gap-8 w-full">
        <div className="flex relative items-center justify-start w-full border-r-8 border-primary pr-3">
          ...
          <Link className="hover:underline hover:text-green-600 transition duration-300" href="/news/all-news">
      ...
      <div className="mt-4 flex items-start justify-start flex-col gap-8 h-[95vh] bg-gradient-to-b from-[#15803cdc] to-[#059668e0] rounded-lg p-6 text-white border-white border-spacing-7 inset-4">
