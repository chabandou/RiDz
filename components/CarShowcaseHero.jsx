    ...
    >
      <div className="flex flex-col w-[90%] xl:w-[60%] items-start justify-start gap-5 ">
        <h1 className="text-[2.6rem] xl:text-6xl font-extrabold leading-normal xl:leading-[4.7rem]">
          ...
          <span className="Algeria">الجزائر!</span>{" "}
        </h1>
      ...
      <div className="relative w-full flex justify-end items-end h-full">
        ...
        <div className="bg-[url('/hero-bg.png')] bg-contain bg-no-repeat absolute top-[60px] bottom-0 xl:top-10 scale-[1.25] xl:scale-150  xl:-left-[40%] w-full h-full xl:h-screen box-border  -z-10 -left-1/4 "></div>
      </div>
    </section>
  );
}
